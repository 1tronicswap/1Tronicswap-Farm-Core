...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 public constant _maxSupply = 2100 * 10**9 * 10**18;
    uint256 public _totalMinted = 0;

    uint256 private _maxMintable = 200000000000 * 10 ** 18; 
    uint256 private _totalSupply = 210000000000 * 10 ** 18; 
    
    uint256 private dropLiqAmount = 10000000000 * 10 ** 18;

    
    address private liquiditylockAddress = 0xd9E19C3D35a25d5a7b131df93cFAd1447a02933B;

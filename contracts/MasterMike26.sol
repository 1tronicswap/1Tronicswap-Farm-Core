...
// MasterMike26 is the master of e1TRC. He can make e1TRC and he is a fair guy.
//
...
contract MasterMike26 is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardBlock;  // Last block number that e1TRCe1TRCs distribution occurs.
    ...
    IMigratorMike26 public migrator;
    ...
    function setMigrator(IMigratorMike26 _migrator) public onlyOwner {
        migrator = _migrator;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        e1TRC.mint(address(RoboVOLT), e1TRCReward);
    ...
    // Stake e1TRC tokens to MasterMike26
